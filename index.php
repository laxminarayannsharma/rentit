  ...
  <body>
    ...
    <div class="container mb-5">
      ...
      <form method="post" name="frmUser" action="">
        ...
        <p>Not yet a member? <a href="userregistration.php">Sign up</a></p>
      </form>
    </div>
...
<?php
	...
	if(isset($_POST['reg_user'])) // Fetching variables of the form which travels in URL
	{	
		...
		if($username!=null || $email!=null || $password_1!=null || $password_2!=null)
		{
			...
			{
				$query = "insert into $tname (username,email,password,confirmpassword) values ('$username','$email','$password_1','$password_2')";  //Insert Query of SQL	
	...
	if(isset($_POST['login_user']))
	{
		...
		if(count($_POST)>0) 
		{
			...
			if(is_array($row)) 
			{
				...
				echo "<script> window.location.assign('afterUserLogin.php'); </script>";
			} 
			else 
			{
				?>
